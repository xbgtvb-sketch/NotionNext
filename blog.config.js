...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xinbg', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专注科技生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xinbg.pro', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '科技生活, 博客', // 网站关键词 英文逗号隔开
